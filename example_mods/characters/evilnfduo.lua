...
idle_xml_name = 'evilguest idle'
left_xml_name = 'evilguest left'
down_xml_name = 'evilguest down'
up_xml_name = 'evilguest up'
right_xml_name = 'evilguest right'
...
name_of_character_xml = 'evilnewassets'
name_of_character = 'evil'
